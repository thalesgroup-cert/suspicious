...
from .variable import dangerous_folders, labels_dangerous, y_dangerous_encoder


class DangerousTrainer:
    MODEL_NAME = "dangerous_30_epochs_model"
    ...
    def preprocess(self):
        ...
        return pre_process(
            dataset_file,
            labels_mapping=labels_dangerous,
            y_encoder_function=y_dangerous_encoder,
            allowed_labels=list(dangerous_folders.keys()),
    ...
    def train(self):
        ...
        save_dataset_info(
            ...
            labels=list(dangerous_folders.keys()),
        )
