...
from .variable import folders, labels_safe_suspicious, y_safe_suspcious_encoder


class Safe_Suspicious_Trainer:
    MODEL_NAME = "safe_suspicious_30_epochs_model"
    ...
    def preprocess(self):
        ...
        return pre_process(
            dataset_file,
            labels_mapping=labels_safe_suspicious,
            y_encoder_function=y_safe_suspcious_encoder,
            allowed_labels=["safe", "suspicious"],
