...
"""
  ...
  <body style="min-width:260px; min-height:100%; padding:0; margin:0 auto; background-color:#EDF1F4;">
    ...
    def _type_mail_table(self):
        img = {
            'type_mail_logo': mail_config['logos'].get('acknowledge-badmail', 'https://example.com/type_mail_logo.png')
        }
        return f"""
    ...
    def _body_table(self):
        ...
        return f"""
            ...
            <tr>
                ...
                <br>
                <div style="line-height: 18px;">Thank you for your submission to the {msg['group']} team.</div>
                <br>
                <div style="line-height: 18px; text-align: center;">
                    Unfortunately, your mail could not be processed because it was not sent in the correct format or perhaps your mail is signed.<br><br>
                    <strong>To be analyzed, the suspicious mail must be sent as a full attachment (not forwarded).</strong> also verify to not sign your mail before sending it to Suspicious.<br><br>
                    In Outlook, right-click on the mail and select <em>"Forward as Attachment"</em>.<br><br>
                    You can also use the CTRL + ALT + F shortcut while having the mail selected<br>
                </div>
                </td>
            </tr>
            </table>
